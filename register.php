...
<html>
<head>
	<title>Welcome to aji njam3o!</title>
...
<body>
     ...
     <div class="back">
        	<div class="login_box">
        		<div class="login_hanler">
        			<h1>aji njam3o!</h1>
                    Login or register to get started!
        		</div>
        		<div id="first">
        			<form action="register.php" method="POST"><!-- form dyal rogister-->
			     	<input type="email" name="log_email" placeholder="Email Address" value="<?php 
					if(isset($_SESSION['log_email'])) {
						echo $_SESSION['log_email'];
						///////bach ib9a 3a9l 3la dakchi lidakhl user ib9a maktob f page la kan 3ando chi khata2 isaho
					} 
					?>" required>
			     	<br>
